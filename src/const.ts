 ...
 * 예식 장소 명칭
 */
export const LOCATION = "우리은행 본점 4층 비전홀"
...
export const BRIDE_FATHER = "노은영아빠"
export const BRIDE_MOTHER = "노은영엄마"
...
export const GROOM_FATHER = "안재하아빠"
export const GROOM_MOTHER = "안재하엄마"
